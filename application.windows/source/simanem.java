...
//    rect(posX-1,posY-1,256,256);
  ...
  public boolean mouseOverSlider(int x,int y){
  ...
  public boolean mouseOverMem(int x,int y){
...
class Pc extends Register{
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "simanem" });
  }
}
