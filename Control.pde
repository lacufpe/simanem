...
class Control{
  ...
  void display(){
    ...
    fill(0);
    text("controle",posX+100,posY+24-1);
    fill(255);
    rect(posX,posY+24,200,120);
    fill(0);
    text(operation,posX+100,posY+96);
    textAlign(LEFT);
    text(binary(controlULA,3),posX+1,posYcULA+10);
    text(binary(controlReg,2),posX+1,posYcReg+10);
    text(binary(controlPC,2),posX+1,posYcPC+10);
    textAlign(RIGHT);
    text(binary(wData,1),posXw-1,posYw+10);
    text(binary(enData,1),posXen-1,posYen+10);
  }
